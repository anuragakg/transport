/**
 * @api {get} masters/commodity View All
 * @apiName CommodityMasterViewAll
 * @apiGroup Commodity Master
 *
...
/**
 * @api {get} masters/commodity/:id View One
 * @apiName CommodityMasterViewOne
 * @apiGroup Commodity Master
 *
...
/**
 * @api {POST} masters/commodity Create
 * @apiName CommodityMasterCreate
 * @apiGroup Commodity Master
...
/**
* @api {PUT} masters/commodity/:id Update
* @apiName CommodityMasterUpdate
* @apiGroup Commodity Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/commodity/:id Delete
 * @apiName CommodityMasterDelete
 * @apiGroup Commodity Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
