/**
 * @api {get} masters/village View All
 * @apiName VillageMasterViewAll
 * @apiGroup Village Master
 *
...
/**
 * @api {get} masters/village/:id View One
 * @apiName VillageMasterViewOne
 * @apiGroup Village Master
 *
...
/**
 * @api {POST} masters/village Create
 * @apiName VillageMasterCreate
 * @apiGroup Village Master
...
/**
* @api {PUT} masters/village/:id Update
* @apiName VillageMasterUpdate
* @apiGroup Village Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/village/:id Delete
 * @apiName VillageMasterDelete
 * @apiGroup Village Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
