/**
 * @api {get} masters/warehouse-type View All
 * @apiName WarehouseTypeMasterViewAll
 * @apiGroup Warehouse Type Master
 *
...
/**
 * @api {get} masters/warehouse-type/:id View One
 * @apiName WarehouseTypeMasterViewOne
 * @apiGroup Warehouse Type Master
 *
...
/**
 * @api {POST} masters/warehouse-type Create
 * @apiName WarehouseTypeMasterCreate
 * @apiGroup Warehouse Type Master
...
/**
* @api {PUT} masters/warehouse-type/:id Update
* @apiName WarehouseTypeMasterUpdate
* @apiGroup Warehouse Type Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/warehouse-type/:id Delete
 * @apiName WarehouseTypeMasterDelete
 * @apiGroup Warehouse Type Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
