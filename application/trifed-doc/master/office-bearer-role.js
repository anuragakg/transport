/**
 * @api {get} masters/office-bearer-role View All
 * @apiName OfficeBearerRoleMasterViewAll
 * @apiGroup Office Bearer Role Master
 *
...
/**
 * @api {get} masters/office-bearer-role/:id View One
 * @apiName OfficeBearerRoleMasterViewOne
 * @apiGroup Office Bearer Role Master
 *
...
/**
 * @api {POST} masters/office-bearer-role Create
 * @apiName OfficeBearerRoleMasterCreate
 * @apiGroup Office Bearer Role Master
...
/**
* @api {PUT} masters/office-bearer-role/:id Update
* @apiName OfficeBearerRoleMasterUpdate
* @apiGroup Office Bearer Role Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/office-bearer-role/:id Delete
 * @apiName OfficeBearerRoleMasterDelete
 * @apiGroup Office Bearer Role Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
