/**
 * @api {get} masters/education View All
 * @apiName EducationMasterViewAll
 * @apiGroup Education Master
 *
...
/**
 * @api {get} masters/education/:id View One
 * @apiName EducationMasterViewOne
 * @apiGroup Education Master
 *
...
/**
 * @api {POST} masters/education Create
 * @apiName EducationMasterCreate
 * @apiGroup Education Master
...
/**
* @api {PUT} masters/education/:id Update
* @apiName EducationMasterUpdate
* @apiGroup Education Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/education/:id Delete
 * @apiName EducationMasterDelete
 * @apiGroup Education Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
