/**
 * @api {get} masters/rpm-ownership View All
 * @apiName RpmOwnershipMasterViewAll
 * @apiGroup RPM Ownership Master
 *
...
/**
 * @api {get} masters/rpm-ownership/:id View One
 * @apiName RpmOwnershipMasterViewOne
 * @apiGroup RPM Ownership Master
 *
...
/**
 * @api {POST} masters/rpm-ownership Create
 * @apiName RpmOwnershipMasterCreate
 * @apiGroup RPM Ownership Master
...
/**
* @api {PUT} masters/rpm-ownership/:id Update
* @apiName RpmOwnershipMasterUpdate
* @apiGroup RPM Ownership Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/rpm-ownership/:id Delete
 * @apiName RpmOwnershipMasterDelete
 * @apiGroup RPM Ownership Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
