/**
 * @api {get} masters/warehouse-condition View All
 * @apiName WarehouseConditionViewAll
 * @apiGroup Warehouse Condition Master
 *
...
/**
 * @api {get} masters/warehouse-condition/:id View One
 * @apiName WarehouseConditionViewOne
 * @apiGroup Warehouse Condition Master
 *
...
/**
 * @api {POST} masters/warehouse-condition Create
 * @apiName WarehouseConditionCreate
 * @apiGroup Warehouse Condition Master
...
/**
* @api {PUT} masters/warehouse-condition/:id Update
* @apiName WarehouseConditionUpdate
* @apiGroup Warehouse Condition Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/warehouse-condition/:id Delete
 * @apiName WarehouseConditionDelete
 * @apiGroup Warehouse Condition Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
