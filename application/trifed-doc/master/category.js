/**
 * @api {get} masters/category View All
 * @apiName CategoryMasterViewAll
 * @apiGroup Category Master
 *
...
/**
 * @api {get} masters/category/:id View One
 * @apiName CategoryMasterViewOne
 * @apiGroup Category Master
 *
...
/**
 * @api {POST} masters/category Create
 * @apiName CategoryMasterCreate
 * @apiGroup Category Master
...
/**
* @api {PUT} masters/category/:id Update
* @apiName CategoryMasterUpdate
* @apiGroup Category Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/category/:id Delete
 * @apiName CategoryMasterDelete
 * @apiGroup Category Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
