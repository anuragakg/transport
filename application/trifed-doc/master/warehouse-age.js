/**
 * @api {get} masters/warehouse-age View All
 * @apiName WarehouseAgeMasterViewAll
 * @apiGroup Warehouse Age Master
 *
...
/**
 * @api {get} masters/warehouse-age/:id View One
 * @apiName WarehouseAgeMasterViewOne
 * @apiGroup Warehouse Age Master
 *
...
/**
 * @api {POST} masters/warehouse-age Create
 * @apiName WarehouseAgeMasterCreate
 * @apiGroup Warehouse Age Master
...
/**
* @api {PUT} masters/warehouse-age/:id Update
* @apiName WarehouseAgeMasterUpdate
* @apiGroup Warehouse Age Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/warehouse-age/:id Delete
 * @apiName WarehouseAgeMasterDelete
 * @apiGroup Warehouse Age Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
