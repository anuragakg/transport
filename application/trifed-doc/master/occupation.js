/**
 * @api {get} masters/occupation View All
 * @apiName OccupationMasterViewAll
 * @apiGroup Occupation Master
 *
...
/**
 * @api {get} masters/occupation/:id View One
 * @apiName OccupationMasterViewOne
 * @apiGroup Occupation Master
 *
...
/**
 * @api {POST} masters/occupation Create
 * @apiName OccupationMasterCreate
 * @apiGroup Occupation Master
...
/**
* @api {PUT} masters/occupation/:id Update
* @apiName OccupationMasterUpdate
* @apiGroup Occupation Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/occupation/:id Delete
 * @apiName OccupationMasterDelete
 * @apiGroup Occupation Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
