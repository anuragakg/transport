/**
 * @api {get} masters/market-regulation View All
 * @apiName MarketRegulationMasterViewAll
 * @apiGroup Market Regulation Master
 *
...
/**
 * @api {get} masters/market-regulation/:id View One
 * @apiName MarketRegulationMasterViewOne
 * @apiGroup Market Regulation Master
 *
...
/**
 * @api {POST} masters/market-regulation Create
 * @apiName MarketRegulationMasterCreate
 * @apiGroup Market Regulation Master
...
/**
* @api {PUT} masters/market-regulation/:id Update
* @apiName MarketRegulationMasterUpdate
* @apiGroup Market Regulation Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/market-regulation/:id Delete
 * @apiName MarketRegulationMasterDelete
 * @apiGroup Market Regulation Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
