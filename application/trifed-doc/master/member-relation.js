/**
 * @api {get} masters/member-relation View All
 * @apiName MemberRelationMasterViewAll
 * @apiGroup Member Relation Master
 *
...
/**
 * @api {get} masters/member-relation/:id View One
 * @apiName MemberRelationMasterViewOne
 * @apiGroup Member Relation Master
 *
...
/**
 * @api {POST} masters/member-relation Create
 * @apiName MemberRelationMasterCreate
 * @apiGroup Member Relation Master
...
/**
* @api {PUT} masters/member-relation/:id Update
* @apiName MemberRelationMasterUpdate
* @apiGroup Member Relation Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/member-relation/:id Delete
 * @apiName MemberRelationMasterDelete
 * @apiGroup Member Relation Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
