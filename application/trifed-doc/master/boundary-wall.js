/**
 * @api {get} masters/boundary-wall View All
 * @apiName BoundaryWallMasterViewAll
 * @apiGroup Boundary Wall Master
 *
...
/**
 * @api {get} masters/boundary-wall/:id View One
 * @apiName BoundaryWallMasterViewOne
 * @apiGroup Boundary Wall Master
 *
...
/**
 * @api {POST} masters/boundary-wall Create
 * @apiName BoundaryWallMasterCreate
 * @apiGroup Boundary Wall Master
...
/**
* @api {PUT} masters/boundary-wall/:id Update
* @apiName BoundaryWallMasterUpdate
* @apiGroup Boundary Wall Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/boundary-wall/:id Delete
 * @apiName BoundaryWallMasterDelete
 * @apiGroup Boundary Wall Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
