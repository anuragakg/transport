/**
 * @api {get} masters/transportation View All
 * @apiName TransportationMasterViewAll
 * @apiGroup Transportation Master
 *
...
/**
 * @api {get} masters/transportation/:id View One
 * @apiName TransportationMasterViewOne
 * @apiGroup Transportation Master
 *
...
/**
 * @api {POST} masters/transportation Create
 * @apiName TransportationMasterCreate
 * @apiGroup Transportation Master
...
/**
* @api {PUT} masters/transportation/:id Update
* @apiName TransportationMasterUpdate
* @apiGroup Transportation Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/transportation/:id Delete
 * @apiName TransportationMasterDelete
 * @apiGroup Transportation Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
