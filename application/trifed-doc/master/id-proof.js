/**
 * @api {get} masters/id-proof View All
 * @apiName IdProofMasterViewAll
 * @apiGroup Id Proof Master
 *
...
/**
 * @api {get} masters/id-proof/:id View One
 * @apiName IdProofMasterViewOne
 * @apiGroup Id Proof Master
 *
...
/**
 * @api {POST} masters/id-proof Create
 * @apiName IdProofMasterCreate
 * @apiGroup Id Proof Master
...
/**
* @api {PUT} masters/id-proof/:id Update
* @apiName IdProofMasterUpdate
* @apiGroup Id Proof Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/id-proof/:id Delete
 * @apiName IdProofMasterDelete
 * @apiGroup Id Proof Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
