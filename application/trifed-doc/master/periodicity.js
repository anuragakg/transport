/**
 * @api {get} masters/periodicity View All
 * @apiName PeriodicityMasterViewAll
 * @apiGroup Periodicity Master
 *
...
/**
 * @api {get} masters/periodicity/:id View One
 * @apiName PeriodicityMasterViewOne
 * @apiGroup Periodicity Master
 *
...
/**
 * @api {POST} masters/periodicity Create
 * @apiName PeriodicityMasterCreate
 * @apiGroup Periodicity Master
...
/**
* @api {PUT} masters/periodicity/:id Update
* @apiName PeriodicityMasterUpdate
* @apiGroup Periodicity Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/periodicity/:id Delete
 * @apiName PeriodicityMasterDelete
 * @apiGroup Periodicity Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
