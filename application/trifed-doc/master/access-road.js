/**
 * @api {get} masters/access-road View All
 * @apiName AccessRoadMasterViewAll
 * @apiGroup Access Road Master
 *
...
/**
 * @api {get} masters/access-road/:id View One
 * @apiName AccessRoadMasterViewOne
 * @apiGroup Access Road Master
 *
...
/**
 * @api {POST} masters/access-road Create
 * @apiName AccessRoadMasterCreate
 * @apiGroup Access Road Master
...
/**
* @api {PUT} masters/access-road/:id Update
* @apiName AccessRoadMasterUpdate
* @apiGroup Access Road Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/access-road/:id Delete
 * @apiName AccessRoadMasterDelete
 * @apiGroup Access Road Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
