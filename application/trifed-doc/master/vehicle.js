/**
 * @api {get} masters/vehicle View All
 * @apiName VehicleMasterViewAll
...
/**
 * @api {get} masters/vehicle/:id View One
 * @apiName VehicleMasterViewOne
 * @apiGroup Vehicle Master
 *
...
/**
 * @api {POST} masters/vehicle Create
 * @apiName VehicleMasterCreate
 * @apiGroup Vehicle Master
...
/**
* @api {PUT} masters/vehicle/:id Update
* @apiName VehicleMasterUpdate
* @apiGroup Vehicle Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/vehicle/:id Delete
 * @apiName VehicleMasterDelete
 * @apiGroup Vehicle Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
