/**
 * @api {get} masters/regulation View All
 * @apiName RegulationMasterViewAll
 * @apiGroup Regulation Master
 *
...
/**
 * @api {get} masters/regulation/:id View One
 * @apiName RegulationMasterViewOne
 * @apiGroup Regulation Master
 *
...
/**
 * @api {POST} masters/regulation Create
 * @apiName RegulationMasterCreate
 * @apiGroup Regulation Master
...
/**
* @api {PUT} masters/regulation/:id Update
* @apiName RegulationMasterUpdate
* @apiGroup Regulation Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {String{..100}} title
...
/**
 * @api {DELETE} masters/regulation/:id Delete
 * @apiName RegulationMasterDelete
 * @apiGroup Regulation Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
