/**
 * @api {get} masters/district?state_id=id View All
 * @apiName DistrictMasterViewAll
 * @apiGroup District Master
 *
...
/**
 * @api {get} masters/district/:id View One
 * @apiName DistrictMasterViewOne
 * @apiGroup District Master
 *
...
/**
 * @api {POST} masters/district Create
 * @apiName DistrictMasterCreate
 * @apiGroup District Master
 *
 * @apiParam (Payload) {Number} state_id
...
/**
* @api {PUT} masters/district/:id Update
* @apiName DistrictMasterUpdate
* @apiGroup District Master
*  
* @apiParam (Parameter) {Number} id Resource ID
* @apiParam (Payload) {Number} state_id
...
/**
 * @api {DELETE} masters/district/:id Delete
 * @apiName DistrictMasterDelete
 * @apiGroup District Master
 *
 * @apiParam (Parameter) {Number} id Resource ID
 * 
