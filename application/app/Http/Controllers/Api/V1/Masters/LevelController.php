...
use App\Http\Resources\Api\Masters\LevelMasterResource as ApiResource;
...
class LevelController extends ApiController
{
    ...
    public function index(Request $request)
    {
        ...
        $items = $this->service->getAll($status);
    ...
    public function show($id)
    {
        ...
        try {
           ...
           return $this->respondWithError('No more levels found in level master');
        }
    }
