...
use App\Http\Resources\Api\Masters\DistrictBlockMasterResource as ApiResource;
use App\Services\Masters\ScheduledTribesService;

class ScheduledTribesController extends ApiController
{
    protected $service;

    public function __construct(ScheduledTribesService $scheduledTribesService)
    {
        $this->service = $scheduledTribesService;
    }
    ...
    public function index(Request $request)
    {
        ...
        $items = $this->service->getAll($state);
