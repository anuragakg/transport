...
use App\Http\Resources\Api\Masters\MultipurposeProcurementResource as ApiResource;
use App\Services\Masters\MultipurposeProcurementService;


class MultipurposeProcurementItemController extends ApiController
{
    protected $service;

    public function __construct(MultipurposeProcurementService $MultipurposeProcurementService)
    {
        $this->service = $MultipurposeProcurementService;
    }
    ...
    public function getitemListing(Request $request)
    {
        //$this->checkPermission('role_view');
       ...
       // try {
            ...
            $items = $this->service->getitemListing($request);
            $items = ApiResource::collection($items);
