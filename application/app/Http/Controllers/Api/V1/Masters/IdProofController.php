...
class IdProofController extends ApiController
{
    protected $service;

    public function __construct(IdProofService $idProofService)
    {
        $this->service = $idProofService;
    }
    /**
    ...
    public function index(Request $request)
    {
        ...
        $list = $this->service->getAll($status);
        $list = ApiResource::collection($list);
