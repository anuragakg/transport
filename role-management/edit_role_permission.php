...
<body>
      ...
      <div class="row wrapper border-bottom w-bg page-heading">
        <div class="col-lg-10">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#"  onclick="window.history.back(-1);">Edit Role Permission</a></li>
          </ol>
        </div>
 ...
 autocomplete="off" type="checkbox" alias={{alias}} name="permission_id[]" onclick="setPermission(this)"  value="{{ id }}" class="permissions {{ group }}" id="permission-{{ id }}" >
  ...
  <script type="text/javascript" src="../assets/js/custom/edit-role-permission.js?v=<?php echo time();?>"></script>
