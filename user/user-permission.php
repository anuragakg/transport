...
<body>
      ...
      <div class="row wrapper border-bottom w-bg page-heading">
        <div class="col-lg-10">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="../role-mapping/permission-mapping.php">Permission Management</a></li>
          </ol>
        </div>
 ...
 autocomplete="off"  id="formId">
              <fieldset class="form-horizontal">
                ...
                <h2 class="col-md-12 roleTitle"></h2>
                  <!-- <div class=" col-md-4">
  ...
  <script id="listPermission" type="x-tmpl-mustache">
    <tr>
      ...
      <td>
        {{#disable}}
        <input 
 autocomplete="off" type="checkbox" alias={{alias}} name="permission_id[]" onclick="setPermission(this)"  value="{{ id }}" class="permissions {{ group }}" id="permission-{{ id }}" disabled>
        {{/disable}}
        {{^disable}}
        <input 
 autocomplete="off" type="checkbox" alias={{alias}} name="permission_id[]" onclick="setPermission(this)"  value="{{ id }}" class="permissions {{ group }}" id="permission-{{ id }}">
        {{/disable}}
      </td>
    </tr>
  </script>
  <?php include('../parts/js-files.php'); ?>
  <script type="text/javascript" src="../assets/js/custom/user-permission-mapping.js?v=<?php echo time();?>"></script>
