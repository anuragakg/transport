...
<head>
  ...
  <title>State Wise Warehouse Count</title>
</head>
...
<div id="wrapper" class="w-bg">
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom w-bg page-heading">
      <div class="col-lg-10">
        <h2>Warehouse <span id="warehouse_status"></span> Count</h2>
        <ol class="breadcrumb">
          <li><a href="../auth/dashboard.php">Dashboard</a></li>
          <li><a herf="#">Warehouse Counts</a></li>
        </ol>
      </div>
          ...
          <div class="ibox">
            <div class="ibox-content">
              ...
              <div class="row clear m-t-xs">
                  <div class="col-md-12">
                      <table class="table table-bordered" id="state-table">
                          ...
                          <tr>
                              <th>Sr. No.</th>                              
                              <th>State Name</th>
                              <th ><span id="warehouse_count_head"></span></th>
                          </tr>
                          </thead>
                          <tbody>
                ...
                </div><a href="javascript:window.history.back()" class="btn btn-primary">Back</a>
            </div>
          </div>
      </div>
...
<script type="text/javascript" src="../assets/js/custom/dashboard/warehouse_statewise.js?v=1.0"></script>
</body>
</html>
