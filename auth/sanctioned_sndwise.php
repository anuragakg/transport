...
<div id="wrapper" class="w-bg">
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom w-bg page-heading">
      <div class="col-lg-10">
        <h2>SND Wise Sanctioned Amount </h2>
        <ol class="breadcrumb">
          <li><a href="../auth/dashboard.php">Dashboard</a></li>
          <li><a herf="#">SND Wise Sanctioned Amount</a></li>
        </ol>
      </div>
...
<script type="text/javascript" src="../assets/js/custom/dashboard/sanctioned_sndwise.js?v=2.0"></script>
</body>
</html>
