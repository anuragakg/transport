...
<head>
  ...
  <title>SND Wise Sanctioned Amount</title>
</head>
...
<div id="wrapper" class="w-bg">
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom w-bg page-heading">
      <div class="col-lg-10">
        <h2>View SND Wise Sanctioned Amount </h2>
        <ol class="breadcrumb">
          <li><a href="../auth/dashboard.php">Dashboard</a></li>
          <li><a herf="#">View SND Wise Sanctioned Amount</a></li>
        </ol>
      </div>
...
<script type="text/javascript" src="../assets/js/custom/dashboard/view_sanctioned_sndwise.js?v=2.0"></script>
</body>
</html>
