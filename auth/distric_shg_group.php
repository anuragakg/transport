...
<head>
  ...
  <title>District Wise SHG Groups Count</title>
</head>
...
<div id="wrapper" class="w-bg">
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom w-bg page-heading">
      <div class="col-lg-10">
        <h2>SHG Groups <span id="vdvk_status"></span> Count</h2>
        <ol class="breadcrumb">
          <li>Dashboard </li>
          <li><a herf="#">SHG Groups</a></li>
        </ol>
      </div>
...
<script type="text/javascript" src="../assets/js/custom/dashboard/shg_groups_districtwise.js?v=<?php echo time();?>"></script>
</body>
</html>
