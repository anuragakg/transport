...
<div id="wrapper" class="w-bg">
  ...
  <div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom w-bg page-heading">
      <div class="col-lg-10">
        <h2>SHG Group Manage</h2>
        <ol class="breadcrumb">
          <li><a href="../auth/dashboard.php">Dashboard</a></li>
          <li><a herf="#">SHG Group Manage</a></li>
        </ol>
      </div>
...
<script type="text/javascript" src="../assets/js/custom/dashboard/state_shg_gatherer.js?v=<?php echo time();?>"></script>
</body>
</html>
